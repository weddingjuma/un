...
<xsl:stylesheet xmlns:fo="http://www.w3.org/1999/XSL/Format"
    ...
    <xsl:variable name="ail-regions-first">
        <fo:region-body region-name="body" border="0mm" margin-bottom="10mm" margin-top="25mm"
            margin-left="0mm" margin-right="5mm" padding="0mm" background-repeat="no-repeat"
        ...
        <fo:page-sequence-master master-name="all-pages">
            <fo:repeatable-page-master-alternatives>
                <fo:conditional-page-master-reference master-reference="first-page"
                    page-position="first"/>
                <fo:conditional-page-master-reference master-reference="other-pages-right"
                    odd-or-even="odd"/>
                <fo:conditional-page-master-reference master-reference="other-pages-left"
                    odd-or-even="even"/>
                <fo:conditional-page-master-reference master-reference="blank-pages"
